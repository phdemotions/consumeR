# Script to create consumer_survey dataset
# Run this script to regenerate data/consumer_survey.rda
...
# Ensure satisfaction is 1-10, loyalty is 0-100, spending is non-negative
...
message("✓ consumer_survey.rda created in data/")
